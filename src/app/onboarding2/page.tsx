...
const NEW: Row[] = [
  ...
  },
  {
    ...
    shot: 'chat-room',
    spec: 'CH-02~04 · CH-09',
    desc: '댓글에서 상대를 지정해 연 방입니다. 더보기에서 신고와 차단, 차단하면 입력칸이 잠깁니다',
    data: '목데이터',
  },
  {
    href: wf('/chat/r0'),
    ...
    spec: 'CH-01 · CH-02~04',
    desc:
      '방장이 댓글 단 사람 중에서 골라 부른 방입니다. 글 하나에 방 하나예요. 더보기를 누르면 신고·차단할 사람을 먼저 고릅니다',
    data: '목데이터',
  },
  {
    href: wf('/me/blocked'),
    ...
    <div className="ob">
      ...
      <section className="ob__sec">
        ...
        <p className="ob__seclead">
          채팅과 그에 딸려 오는 것들입니다. 앞의 셋이 서로를 물고 있어서 하나만 떼어낼 수
          없습니다 — 채팅을 넣으면 휴대전화 인증이 법으로 따라오고, 차단이 없으면 빠져나갈 수
          없는 대화가 생깁니다.
        </p>
        <p className="ob__seclead">
          <b>방이 두 가지입니다.</b> 1:1 은 댓글에서 상대를 지정해 열고, 단체는 방장이 댓글 단
          사람 중에서 골라 부릅니다. 신청·수락 화면을 따로 만들지 않은 자리를 이 초대가
          대신합니다 — 방장만 누르므로 절차가 한 번에 끝나고, 모집글 정원이 곧 방 인원이
          됩니다.
        </p>
        <p className="ob__seclead">
      ...
      <section className="ob__sec">
        ...
        <div className="ob__miss">
          ...
          <p>
            <b>방으로 들어오는 입구가 아직 없습니다.</b> 목록과 방은 있는데 방이 어디서
            생기는지가 화면에 없어서, 지금은 목데이터에 이미 방이 있는 상태로 시작합니다.
            모집글 상세에 「채팅하기」가 붙어야 흐름이 이어집니다.
          </p>
          <p>
