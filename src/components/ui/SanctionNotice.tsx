...
export function SanctionBlock({ sanction }: { sanction: Sanction }) {
  ...
  return (
    <div className="sblock">
      ...
      {/* 정지를 받은 사람이 다음에 떠올리는 것이 「나갔다 다시 들어오면
          되지 않나」 다. 약관 제12조가 그것을 제8조 위반으로 보고,
          처리방침이 이용 제한 기록을 탈퇴 뒤에도 남겨두는 이유가 바로
          그것이다. 두 문서에는 적어 뒀는데 정작 제재를 받은 화면에는
          없었다 — 나중에 알면 같은 일로 두 번 벌받는 셈이 된다 */}
      <p className="sblock__again">
        {banned
          ? '탈퇴한 뒤 다시 가입해도 이용하실 수 없어요.'
          : '탈퇴한 뒤 다시 가입해도 남은 기간은 그대로예요.'}{' '}
        이용 제한 기록은 탈퇴해도 정해진 기간 동안 남습니다.
      </p>
